...
echo ""
echo "✅ MinIO iniciado!"
echo "📁 API disponível em: http://localhost:19000 (departamento-estadual-rodovias)"
echo "🖥️ Console web disponível em: http://localhost:19001 (departamento-estadual-rodovias)"
echo "👤 Usuário: admin"
...
echo "  MINIO_ENDPOINT=http://localhost:19000"
